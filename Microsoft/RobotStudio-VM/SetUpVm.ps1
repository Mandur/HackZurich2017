try
{
  ...
  if (!(Get-Module -Name PowerShellGet))
  {
      ...
      #Invoke-WebRequest 'https://raw.githubusercontent.com/Mandur/HackZurich2017/master/Microsoft/RobotStudio-VM/HackZurich.rspag' -OutFile $($env:temp +'\RobotStudio_6.05.02.zip')
